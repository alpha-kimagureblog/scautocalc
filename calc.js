...
function skillDisabled(allData,skNameList){
	...
	for (var index4 = 0; index4 < skNameList.length; index4++) {
		if (eval(`skillList.${skNameList[index4]}[0].sc`) != "SC:-"){
			...
			tdid1 = eval(`allData.${skNameList[index4]}.name`)
			tdid2 = eval(`allData.${skNameList[index4]}.name + "sub"`)
			document.getElementById(eval(`tdid1`)).bgColor = "#e6e6e6";
			document.getElementById(eval(`tdid2`)).bgColor = "#e6e6e6";
		}
	}
}
...
const skillList = {
	...
	,"sk186" : [{"id":"#sk186","skill":"麻痺耐性","sc":"SC:5","eff":"麻痺がかかりにくくなる(麻痺が弱点の場合は弱点を消す)"},{"arc":["a034"],"lv":[3]}]
	...
	,"sk246" : [{"id":"#sk246","skill":"栄光の美酒","sc":"SC:4","eff":"バトル終了時、SCTが回復する"},{"arc":["a052"],"lv":[6]}]
	...
	,"sk263" : [{"id":"#sk263","skill":"トリプルインパクト","sc":"SC:11","eff":"通常攻撃時、追加ダメージ×2"},{"arc":["a033"],"lv":[10]}]
	...
	,"sk271" : [{"id":"#sk271","skill":"チャンスドライブ","sc":"SC:6","eff":"気絶、ブレイク状態の敵に対するダメージ量アップ"},{"arc":["a079"],"lv":[10]}]
	...
	,"sk281" : [{"id":"#sk281","skill":"ファストクリティカル","sc":"SC:2","eff":"戦闘開始時に自動クリティカル発動"},{"arc":["a001"],"lv":[6]}]
	...
	,"sk287" : [{"id":"#sk287","skill":"チャージ特技2","sc":"SC:3","eff":"バトル開始時に2番目の特技(右上に位置する特技)を一定量回復"},{"arc":["a009"],"lv":[6]}]
	...
	,"sk296" : [{"id":"#sk296","skill":"急所狙い・改","sc":"SC:6","eff":"クリティカル発生時の威力を50%上げる"},{"arc":["a003"],"lv":[8]}]
	...
	,"sk316" : [{"id":"#sk316","skill":"クイックトリガー","sc":"SC:6","eff":"バトル開始時に、特技のどれかがランダムで1回分回復する"},{"arc":["a011"],"lv":[5]}]
	...
	,"sk324" : [{"id":"#sk324","skill":"ローブハイブースト","sc":"SC:9","eff":"ローブ装備時にMNDが20%アップし、魔法攻撃の威力が20%アップ"},{"arc":["a008"],"lv":[10]}]
	...
	,"sk336" : [{"id":"#sk336","skill":"ライフブレイブ","sc":"SC:-","eff":"自身の残りHPが少ないほどSTRがアップ(最大+50%)"},{"arc":[""],"lv":[]}]
	...
	,"sk341" : [{"id":"#sk341","skill":"無属性アタックレイズ","sc":"SC:-","eff":"無属性攻撃を強化する"},{"arc":[""],"lv":[]}]
	...
	,"sk370" : [{"id":"#sk370","skill":"ウイッチスレイヤー","sc":"SC:-","eff":"物理攻撃で魔法使い系に効果大"},{"arc":[""],"lv":[]}]
	...
	,"sk377" : [{"id":"#sk377","skill":"剣ブースト","sc":"SC:-","eff":"剣装備時に物理攻撃の威力が10%アップ"},{"arc":[""],"lv":[]}]
