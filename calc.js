...
function getUnitSkill(allData){
	...
	switch (select.options[index].value) {
		...
		break;
		case "uni060":
		return  unitSkillList.uni060;
		break;
		case "uni061":
		return  unitSkillList.uni061;
		break;
		case "uni062":
		return  unitSkillList.uni062;
		break;
		default:
		return null;
	}
...
const unitSkillList = {
	...
	,uni060 : ["sk105","sk381","sk107","sk121","sk122","sk123","sk296","sk483","sk314","sk202","sk170","sk484","sk242","sk258","sk265","sk396","sk271","sk272","sk485","sk486","sk487"]
	,uni061 : ["sk034","sk041","sk495","sk064","sk496","sk065","sk497","sk330","sk498","sk056","sk333","sk402","sk290","sk221","sk228","sk234","sk170","sk484","sk241","sk278","sk374","sk411","sk287","sk499","sk500"]
	,uni062 : ["sk501","sk036","sk037","sk038","sk039","sk040","sk041","sk502","sk103","sk402","sk115","sk503","sk504","sk341","sk430","sk244","sk248","sk252","sk278","sk505","sk492","sk374","sk411","sk316","sk268","sk395"]
}

// アーク一覧
const arcData = {
	"a001" : ["異国メグロナ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/megurona/"]
	,"a002" : ["空艇ロンヴァリオン(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/ronvalion/"]
	,"a003" : ["屍山に立つ狂剣(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/mad-sword/"]
	,"a004" : ["神獣ログ・メキア(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/log-mechia/"]
	,"a005" : ["海賊船レグニス号(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/regnis/"]
	,"a006" : ["冥皇門デスノーグ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/deathnogue/"]
	,"a007" : ["グラナ海の脅威(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a008" : ["導きの星鐘楼(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a009" : ["栄光のカルディナ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a010" : ["蒼氷の守護騎士(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/guardian-knight/"]
	,"a011" : ["聖夜の願い事(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a012" : ["星屑のLIVE(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/stardust-live/"]
	,"a013" : ["超砂獣の霊帝牙(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a014" : ["大天使の微笑(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a015" : ["聖剣伝説2(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a016" : ["神獣を狩る者(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/beast-hunter/"]
	,"a017" : ["天弓スターロード(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/star-road/"]
	,"a018" : ["ヴェル＝ジ＝オーグ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a019" : ["秘奥録「灼鳳破」(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a020" : ["マジャ大神殿(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a021" : ["終末の命誓(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a022" : ["ゴルド戦争(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a023" : ["ゴーレム・コア(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/corem-core/"]
	,"a024" : ["聖剣伝説FF外伝(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a025" : ["古代兵器ローガーン(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a026" : ["ババラードの毒竜(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a027" : ["天聖女の凱旋(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a028" : ["深海の廃都ノノ・パクラ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a029" : ["竜宝レイニクル(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/rainicle/"]
	,"a030" : ["魔獣ハンター(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a031" : ["邪教神殿(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a032" : ["緋炎の英傑(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a033" : ["洞闇の酒坏(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a034" : ["天空城の雷神(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a035" : ["宝剣エリュード(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a036" : ["秘宝マルキュロディン(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a037" : ["ゼルエンの亡霊(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a038" : ["白騎士の休息(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a039" : ["乙女の祈り(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a040" : ["魔鏡ポムラム(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a041" : ["禁書の眠る祭壇(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a042" : ["剣聖墓メノン(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a043" : ["オルダーナ闘技場(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a044" : ["鏡鎧ミゼル(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a045" : ["グラン・バーガン(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a046" : ["聖旗ノルレアン(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a047" : ["聖剣伝説3(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a048" : ["海竜神殿グラナ・ダリア(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a049" : ["永久時計デ＝ロウ(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a050" : ["ポックルの隠れ里(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a051" : ["ブラッディムーン(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a052" : ["ゴルドの奇跡(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a053" : ["隠者の禁室(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a054" : ["ガイエスト修剣山(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a055" : ["ソーサラーエデン(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a056" : ["月下斬明(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a057" : ["リバラザードの生誕(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a058" : ["海岸線の破剣(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a059" : ["ファルニアの花(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a060" : ["ラドムーン賢封蹟(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a061" : ["人工エーテル(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a062" : ["焔鳥レミの卵(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a063" : ["聖火シュミライア(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a064" : ["白銀雪虹(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a065" : ["蜃気楼の砂塔(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a066" : ["雷宝石の光輝(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a067" : ["絶断門ベガンダ(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a068" : ["ジャイアント・ツリー(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a069" : ["異界次元の狭間(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a070" : ["アルダンの戦士(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a071" : ["蒼光騎士団(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a072" : ["フェアリーズフォレスト(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a073" : ["巨雷雲ゼラニア(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a074" : ["ポックルイーター(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a075" : ["白の研究所(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a076" : ["交易港グラナダ(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a077" : ["魔女が棲む家(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a078" : ["魔獣たちの秘湯(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a079" : ["クリスタルキャッスル(R)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
  ,"a080" : ["死霊の大軍勢(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/large-army/"]
	,"a081" : ["幻異門ユドレール(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a082" : ["ブレイズガーデン(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a083" : ["皇竜エルド・ラヴァーナ(UR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a084" : ["科学の灯(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a085" : ["STONE WORLD(SR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a085" : ["硫酸の泉(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/"]
	,"a086" : ["銀灰色の剣星譚(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/silver-gray-sword-satan/"]
	,"a087" : ["解き放たれし獣王(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/beast-king/"]
	,"a088" : ["爆風竜ヴェルドラ(SSR)","https://alpha-kimagureblog.xyz/lastcloudia/arc/storm-dragon/"]
...
const skillList = {
	...
	,"sk021" : [{"id":"#sk021","skill":"ゴッドヒール","sc":"SC:8","eff":"味方単体のHPを大回復"},{"arc":["a009","a091"],"lv":[10,8]}]
	...
	,"sk057" : [{"id":"#sk057","skill":"ファイアウォール","sc":"SC:5","eff":"味方全体の樹属性ダメージを20%カット"},{"arc":["a062","a089"],"lv":[7,1]}]
	...
	,"sk176" : [{"id":"#sk176","skill":"機械装備","sc":"SC:2","eff":"機械を装備できるようになる"},{"arc":["a002","a082"],"lv":[4,4]}]
	...
	,"sk197" : [{"id":"#sk197","skill":"オートブレイブ","sc":"SC:7","eff":"常にブレイブの効果(攻撃力アップ)"},{"arc":["a029","a092"],"lv":[8,5]}]
	,"sk198" : [{"id":"#sk198","skill":"オートプロテクション","sc":"SC:7","eff":"常にプロテクションの効果(物理ダメージ減少)"},{"arc":["a046"],"lv":[10]}]
	,"sk199" : [{"id":"#sk199","skill":"オートオーラ","sc":"SC:7","eff":"常にオーラの効果(魔力アップ)"},{"arc":["a020","a092"],"lv":[10,7]}]
	...
	,"sk216" : [{"id":"#sk216","skill":"炎ブースト","sc":"SC:3","eff":"炎属性魔法攻撃の威力が10%アップ"},{"arc":["a041","a089"],"lv":[6,3]}]
	...
	,"sk229" : [{"id":"#sk229","skill":"炎クリティカル","sc":"SC:6","eff":"炎属性攻撃魔法がクリティカルするようになる"},{"arc":["a062","a089"],"lv":[10,5]}]
	...
	,"sk244" : [{"id":"#sk244","skill":"栄誉のポーズ","sc":"SC:2","eff":"敵にトドメを刺した時、MPが5%回復する"},{"arc":["a059","a090"],"lv":[5,1]}]
	,"sk245" : [{"id":"#sk245","skill":"勝利の美酒","sc":"SC:4","eff":"バトル終了時、HPが20%回復する"},{"arc":["a033","a082"],"lv":[6,2]}]
	...
	,"sk272" : [{"id":"#sk272","skill":"ブレイカー","sc":"SC:5","eff":"ブレイク値を増やす"},{"arc":["a005","a007","a088"],"lv":[1,1,1]}]
	...
	,"sk279" : [{"id":"#sk279","skill":"精霊呼吸法","sc":"SC:4","eff":"HPが回復するスキルを受けた時、SCTが少し回復する"},{"arc":["a014","a091"],"lv":[2,1]}]
	...
	,"sk337" : [{"id":"#sk337","skill":"マキュアパラライズ","sc":"SC:6","eff":"味方全体の麻痺を回復"},{"arc":["a091"],"lv":[3]}]
	,"sk338" : [{"id":"#sk338","skill":"ガードインパクト","sc":"SC:-","eff":"(ガード装備時のみ発動)ガード時に確率で衝撃を出して近くの敵をひるませる"},{"arc":[""],"lv":[]}]
	,"sk339" : [{"id":"#sk339","skill":"MPアップ4","sc":"SC:4","eff":"MPを15%アップする"},{"arc":["a090"],"lv":[3]}]
	...
	,"sk351" : [{"id":"#sk351","skill":"マシーンスレイヤー","sc":"SC:8","eff":"物理攻撃で機械系に効果大"},{"arc":["a082"],"lv":[6]}]
	...
	,"sk368" : [{"id":"#sk368","skill":"コンボマスター","sc":"SC:9","eff":"連続コンボ中の威力が上がる"},{"arc":["a092"],"lv":[9]}]
	...
	,"sk420" : [{"id":"#sk420","skill":"科学の万能薬","sc":"SC:6","eff":"味方単体の毒・暗闇・沈黙・呪い・病気・麻痺を回復"},{"arc":["a085"],"lv":[3]}]
	...
	,"sk480" : [{"id":"#sk480","skill":"炎属性シールド","sc":"SC:10","eff":"敵から受ける炎属性攻撃の被ダメージ-20%"},{"arc":["a089"],"lv":[8]}]
	,"sk481" : [{"id":"#sk481","skill":"極炎獄霊覇","sc":"SC:10","eff":"中範囲の敵に炎属性の強力な攻撃"},{"arc":["a089"],"lv":[9]}]
	,"sk482" : [{"id":"#sk482","skill":"漫依(イフリート)","sc":"SC:9","eff":"常にHPが減るが、物理ダメージ+20%、炎属性攻撃の被ダメージ-20%"},{"arc":["a089"],"lv":[10]}]
	,"sk483" : [{"id":"#sk483","skill":"ヒューマンシールド","sc":"SC:-","eff":"人間系から受けるダメージ-20%<br>(ソルジャー·ナイト·スナイパー·ソーサラー)"},{"arc":[""],"lv":[]}]
	,"sk484" : [{"id":"#sk484","skill":"闇クリティカルレイズ","sc":"SC:-","eff":"闇属性攻撃のクリティカル発生率5%上昇<br>クリティカル発生時の威力を50%上昇"},{"arc":[""],"lv":[]}]
	,"sk485" : [{"id":"#sk485","skill":"チビっ娘","sc":"SC:-","eff":"敵から攻撃を受けると低確率でSTR+35%アップの効果を付与"},{"arc":[""],"lv":[]}]
	,"sk486" : [{"id":"#sk486","skill":"理不尽魔王","sc":"SC:-","eff":"物理攻撃·超必殺技のダメージ上限アップ+5000"},{"arc":[""],"lv":[]}]
	,"sk487" : [{"id":"#sk487","skill":"魔王の妖気(オーラ)","sc":"SC:-","eff":"闇属性の物理攻撃。超必殺技のダメージ+30%"},{"arc":[""],"lv":[]}]
	,"sk488" : [{"id":"#sk488","skill":"スピリットシールド","sc":"SC:9","eff":"精霊系タイプから受けるダメージ-10%"},{"arc":["a090"],"lv":[5]}]
	,"sk489" : [{"id":"#sk489","skill":"気絶耐性","sc":"SC:6","eff":"気絶しづらくなる"},{"arc":["a090"],"lv":[8]}]
	,"sk490" : [{"id":"#sk490","skill":"樹属性シールド","sc":"SC:10","eff":"敵から受ける樹属性攻撃の被ダメージ-20%"},{"arc":["a090"],"lv":[9]}]
	,"sk491" : [{"id":"#sk491","skill":"オートメティス","sc":"SC:7","eff":"常に魔法「メティス」の効果が掛かった状態になる"},{"arc":["a090"],"lv":[10]}]
	,"sk492" : [{"id":"#sk492","skill":"ファストバイタリティ","sc":"SC:3","eff":"戦闘開始時にバイタリティを自動で発動"},{"arc":["a091"],"lv":[5]}]
	,"sk493" : [{"id":"#sk493","skill":"病気無効","sc":"SC:10","eff":"病気を無効化する<br>病気が弱点の場合は病気耐性になる"},{"arc":["a091"],"lv":[7]}]
	,"sk494" : [{"id":"#sk494","skill":"回復ハイブースト","sc":"SC:8","eff":"回復魔法の威力が30%アップ"},{"arc":["a091"],"lv":[10]}]
	,"sk492" : [{"id":"#sk492","skill":"杖ブースト","sc":"SC:4","eff":"杖装備時に魔法攻撃の威力が10％アップ"},{"arc":["a092"],"lv":[1]}]
	,"sk493" : [{"id":"#sk493","skill":"ファストヘイスト","sc":"SC:5","eff":"戦闘開始時にヘイストを自動で発動"},{"arc":["a092"],"lv":[3]}]
	,"sk494" : [{"id":"#sk494","skill":"炎アタックレイズ2","sc":"SC:15","eff":"炎属性攻撃の威力が30％アップ"},{"arc":["a092"],"lv":[10]}]
	,"sk495" : [{"id":"#sk495","skill":"ハイブレイサー","sc":"SC:-","eff":"敵単体のSTRを35%ダウン"},{"arc":[""],"lv":[]}]
	,"sk496" : [{"id":"#sk496","skill":"ハイスイン","sc":"SC:-","eff":"敵単体のDEFを35%ダウン"},{"arc":[""],"lv":[]}]
	,"sk497" : [{"id":"#sk497","skill":"ハイロストマ","sc":"SC:-","eff":"敵単体のINTを35%ダウン"},{"arc":[""],"lv":[]}]
	,"sk498" : [{"id":"#sk498","skill":"サマーテンプテーション","sc":"SC:-","eff":"敵単体のSTR· INTを50%ダウン<br>(クエスト中に一度だけ使用可能)"},{"arc":[""],"lv":[]}]
	,"sk499" : [{"id":"#sk499","skill":"ラブリーステップ","sc":"SC:-","eff":"バトル開始時、敵全体のSTR・DEF・INT・MNDのいずれか1つを35％ダウン"},{"arc":[""],"lv":[]}]
	,"sk500" : [{"id":"#sk500","skill":"ドキドキステップ","sc":"SC:-","eff":"敵のSTR・DEF・INT・MNDのいずれかをダウンさせた時、ダウンさせた分だけ自分はそのステータスがアップ"},{"arc":[""],"lv":[]}]
	,"sk501" : [{"id":"#sk501","skill":"魔導のカリスマ","sc":"SC:-","eff":"味方全体魔法ダメージ上限アップ＋2000<br>※自身生存時のみ。他カリスマ重複不可"},{"arc":[""],"lv":[]}]
	,"sk502" : [{"id":"#sk502","skill":"アポカリプス","sc":"SC:-","eff":"敵全体に無属性の超強力な攻撃<br>(ダメージ上限999999まで)"},{"arc":[""],"lv":[]}]
	,"sk503" : [{"id":"#sk503","skill":"魔導アップ4","sc":"SC:-","eff":"INT・MPを10％アップする"},{"arc":[""],"lv":[]}]
	,"sk504" : [{"id":"#sk504","skill":"オート上級魔法陣","sc":"SC:-","eff":"常に上級魔法陣展開の効果が掛かった状態になる<br>(MPを徐々に回復)"},{"arc":[""],"lv":[]}]
	,"sk505" : [{"id":"#sk505","skill":"魔武転輪","sc":"SC:-","eff":"魔力が高いほど物理攻撃の威力が上がる"},{"arc":[""],"lv":[]}]
}
